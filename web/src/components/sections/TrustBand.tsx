...
/**
 * Trust band: monthly price on the left, teachers on the right.
    ...
    <section id="narxlar" className="relative bg-canvas py-20 sm:py-28 lg:py-32" aria-labelledby="trust-title">
      <div className="container-x">
        ...
        <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr]">
          {/* Price */}
          <Reveal className="glass relative flex flex-col justify-center overflow-hidden rounded-[var(--radius-2xl)] p-7 sm:p-10">
            <div className="pointer-events-none absolute -left-16 -bottom-16 size-56 rounded-full bg-blue/20 blur-3xl" aria-hidden="true" />
            <div id="narx" className="relative scroll-mt-24">
              <p className="eyebrow">
