...
export default function NotFound() {
  return (
    <main className="container-x flex min-h-dvh flex-col items-center justify-center py-24 text-center">
      ...
      <h1 className="headline mt-8 text-4xl text-ink">Bu sahifa topilmadi</h1>
      <p className="mt-3 max-w-md text-ink/65">Riko ham adashib qoldi. Bosh sahifaga qaytib, yo‘lni birga davom ettiramiz.</p>
